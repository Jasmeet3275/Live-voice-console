...
import { useConsoleSkin } from '@/components/domain/consoleSkin'
...
import { MiniSpeaker } from '@/components/domain/MiniSpeaker'
...
import { BookingRail } from '@/components/domain/BookingRail'
import { AgentSteps } from '@/components/domain/AgentSteps'
import { Transport } from '@/components/domain/Transport'
import { WaveformTrack } from '@/components/domain/WaveformTrack'
import { ConsoleHeader } from '@/components/domain/ConsoleHeader'
import { WordCheckpoint, ConfirmCheckpoint, PaymentCheckpoint, HandoffCheckpoint } from '@/components/domain/checkpoints'
import { CallEndedReceipt, CallDroppedCheckpoint } from '@/components/domain/callEnd'
import { TranscriptPanel } from '@/components/domain/TranscriptPanel'
import { AiThinkingBubble, ResolvedInlineRow, TakeOverBar, OperatorNotice, ThreadNotice, StruckWord, HighlightWord } from '@/components/domain/threadParts'
import { InlineSlotPick } from '@/components/domain/inlineInputs'
import { MobileConsole } from '@/components/domain/MobileConsole'
